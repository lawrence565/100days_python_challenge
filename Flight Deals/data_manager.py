...
SHEETY_ENDPOINT = "https://api.sheety.co/f505c85ccf6b21da99164e646ed462cb/flightDeals/prices"
...
class DataManager:
    ...
    def get_destination_data(self) -> List:
        response = requests.get(SHEETY_ENDPOINT, headers={"Authorization": self._authorization})
